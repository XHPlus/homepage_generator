...
- Computer Vision
- CNN Compiler
- System on Machine Learning

education:
  courses:
  - course: MEng in Computer Sicence
...
- icon: envelope
  icon_pack: fas
  link: "mailto:gongruihao@nlsde.buaa.edu.cn" # '#contact'  # For a direct email link, use "mailto:test@example.org".
- icon: google-scholar
  icon_pack: ai
  link: https://scholar.google.com/citations?user=8i7Z15kAAAAJ&hl=en&oi=ao
- icon: github
  icon_pack: fab
